...
class assignment : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.card1.setOnClickListener{ startbranch("FirstYear") }
        binding.card2.setOnClickListener{ startbranch("SecondYear") }
        binding.card3.setOnClickListener{ startbranch("ThirdYear") }
        binding.card4.setOnClickListener { startbranch("FourthYear") }
    }
